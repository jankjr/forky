...
declare module "./load.cjs" {
     ...
     * Defaults to 50
     */
    function createSimulator(stateProvider: string, linkType: LinkType, opts?: {
...
export declare function createSimulator(stateProvider: string, linkType: LinkType, opts?: {
    secondsPerBlock?: number;
    forkBlock?: number;
    traceProvider?: string;
    maxBlocksBehind?: number;
